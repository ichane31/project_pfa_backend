...
import com.example.pfa_backend.repositories.SecretaireRepository;
...
public class SecretaireService {
    ...
    public List<Secretaire> findBySexeAndDateEmbocheBetween(String sexe, String startDate, String endDate) {
    ...
    public Secretaire updateSecretaire(Long id, SecretaireRequest secretaire) throws NotFoundException {
    ...
    public List<Secretaire> searchSecretaires(String sexe, String startDate, String endDate, String nom, String prenom, String adresse) {
