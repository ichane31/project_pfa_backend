...
import com.example.pfa_authentification.email.context.ForgotPasswordEmailContext;
import com.example.pfa_authentification.email.service.EmailServiceConf;
import com.example.pfa_authentification.exception.InvalidTokenException;
import com.example.pfa_authentification.exception.InvalidUserDataException;
import com.example.pfa_authentification.exception.NotFoundException;
import com.example.pfa_authentification.models.User;
import com.example.pfa_authentification.payload.request.ChangePasswordDto;
import com.example.pfa_authentification.payload.request.LoginRequest;
import com.example.pfa_authentification.payload.request.ResetPassword;
import com.example.pfa_authentification.payload.response.UserInfoResponse;
...
public class UserService {
    ...
    public void sendResetPasswordEmail(User user) {
        ...
        user.setPassTokenExpiryTime(tokenExpiryTime);
        ...
        forgotPasswordEmailContext.setToken(token);
        forgotPasswordEmailContext.buildVerificationUrl(url,token);
        try {
